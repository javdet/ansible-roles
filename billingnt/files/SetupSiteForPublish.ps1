...
#       {
            ...
            if(GrantAccessToSiteScope ($deploymentUserName) $siteName)
            {
                $hostname = GetPublicHostName
...
# QX6gghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# hkiG9w0BCQUxDxcNMTQwOTI2MTc1MDAyWjAjBgkqhkiG9w0BCQQxFgQUWutrNyHp
# OyGB6WfyJVznGres1VswDQYJKoZIhvcNAQEFBQAEggEAiKtjgxGRoZ9+apDlAgYD
# 1vZ9t9Gace0FOMGvhyQQiJRfCkgJVCiC+q/TKGhAuf02ubstEGNALcy9s1J51Oiu
# DSjlQokQ/YhpJx7N7GIIgnSfwpfqeXasBARqajzxRV4KuiU0i6+3GnENDNEx8WOI
# Ao2V4SCnD/UWOKSDT3NFHNVpCbJcSNQa8Bcs7N1d4RWkojakSQbdwOfBuO7Owmii
# iFdRZtxw+dxxPmRcubKecH+YTOAseWYw7tACGqQtN3ssBlBTEsVIoMZ1vg3uDw8t
# qhMuWQItoSZ/awX4/W8cjinNWIytuBOJfmQ8KsTDLlHk+pjydcoC7480lD01qp0L
# QQ==
